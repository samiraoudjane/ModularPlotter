...
db_filename = "processing 2_1.db"
connection = sqlite3.connect(db_filename)
cursor = connection.cursor()

# Select data from the "bacteria_0" table
cursor.execute("SELECT * FROM bacteria_1")
...
# Add labels and legend
plt.title('one_absorbance')
plt.ylabel('absorbance(ratio)')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'one_Absorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
...
# Add labels and legend
plt.title('one_Luminescence/absorbance')
plt.ylabel('Luminescence(arb)/absorbance')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'one_LuminescenceOverAbsorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
...
# Add labels and legend
plt.title('one_GFP/absorbance')
plt.ylabel('GFP(arb)/absorbance')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'one_GFPoverAbsorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
