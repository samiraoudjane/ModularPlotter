...
db_filename = "processing 2_0.db"
connection = sqlite3.connect(db_filename)
cursor = connection.cursor()

# Select data from the "bacteria_0" table
cursor.execute("SELECT * FROM bacteria_0")
...
# Add labels and legend
plt.title('zero_absorbance')
plt.ylabel('absorbance(ratio)')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'zero_Absorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
...
# Add labels and legend
plt.title('zero_Luminescence/absorbance')
plt.ylabel('Luminescence(arb)/absorbance')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'zero_LuminescenceOverAbsorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
...
# Add labels and legend
plt.title('zero_GFP/absorbance')
plt.ylabel('GFP(arb)/absorbance')
plt.xlabel('Time(hours)')

# Save the plot as a PNG file with the title as the file name
plot_title = 'zero_GFPoverAbsorbance.png'
plot_path = os.path.join('plots', plot_title)
plt.savefig(plot_path)
